export const data = {
    experience: [
        ...
        },
        {
            ...
            endDate: "Jun 2022",
            description:
                "Developed and customized Magento extensions using PHP, JavaScript, AJAX, and MySQL to enhance e-commerce platform functionality. Collaborated with the team to improve site performance, fix bugs, and deliver client-requested features that increased overall usability and customer engagement."
        }
    ],
    education: [
        {
